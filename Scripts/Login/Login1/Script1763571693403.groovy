...
WebUI.setText(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/input_Username_txt-username'), 
    'John Doe')

WebUI.setEncryptedText(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/input_Password_txt-password'), 
    'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/button_Password_btn-login'))

WebUI.click(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/input_Apply for hospital readmission_chk_ho_9218d5'))

WebUI.click(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/input_Medicare_radio_program_medicare'))

WebUI.click(findTestObject('Object Repository/CURA Objects/Page_CURA Healthcare Service/div_Visit Date (Required)_input-group-addon'))
